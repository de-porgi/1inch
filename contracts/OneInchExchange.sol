...
import "https://github.com/de-porgi/aave_v2/blob/main/contracts/dependencies/openzeppelin/contracts/Ownable.sol";
import "https://github.com/de-porgi/aave_v2/blob/main/contracts/dependencies/openzeppelin/contracts/SafeERC20.sol";
...
contract OneInchExchange is Ownable, Pausable {
        ...
        returns (uint256 returnAmount)
    {
        ...
        if (flags & _REQUIRES_EXTRA_ETH != 0) {
            require(msg.value > (srcToken.isETH() ? desc.amount : 0), "Invalid msg.value, more");
        } else {
            require(msg.value == (srcToken.isETH() ? desc.amount : 0), "Invalid msg.value, equal");
        }
        ...
        if (flags & _PARTIAL_FILL != 0) {
            ...
            require(returnAmount.mul(desc.amount) >= desc.minReturnAmount.mul(spentAmount), "Return amount is not enough Flags");
        } else {
            require(returnAmount >= desc.minReturnAmount, "Return amount is not enough No flags");
        }
